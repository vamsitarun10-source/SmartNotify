    ...
    <View style={{ flex: 1, backgroundColor: t.background }}>
      ...
      <ScrollView contentContainerStyle={{ padding: t.spacing.md, paddingBottom: 90 }}>
        ...
        {noteType === "text" ? (
          ...
          <Field label={`${noteType === "image" ? "Image" : noteType === "pdf" ? "PDF" : "Voice"} filename`}>
            <TextInput
              style={input(t)}
              value={attachmentName} onChangeText={setAttachmentName}
              placeholder={`e.g. ${noteType === "image" ? "photo.jpg" : noteType === "pdf" ? "notes.pdf" : "recording.m4a"}`}
              placeholderTextColor={t.textTertiary}
            />
          </Field>
        )}
